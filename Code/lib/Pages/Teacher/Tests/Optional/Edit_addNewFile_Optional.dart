...
class EditNewFile_Page_Optional extends StatefulWidget {

  late String FileTitle, FileType, FileTime, FileDescription, File;
  EditNewFile_Page_Optional ({Key? key,
...
class _EditNewFileState extends State<EditNewFile_Page_Optional> {
