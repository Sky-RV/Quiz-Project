...
import 'package:quiz/Pages/Teacher/Tests/Optional/Edit_addNewFile_Optional.dart';
import 'package:quiz/Pages/Teacher/Tests/Optional/Add_NewFile_Optional.dart';

import 'ManageTestQuestions.dart';

class AddTest_Page_2_Optional extends StatelessWidget{
        ...
        actions: [
          TextButton(
            onPressed: (){
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => AddNewFile_Optional())
              );
            },
                    ...
                    child: Padding(
                      ...
                      child: ListTile(
                        onTap: (){
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => EditNewFile_Page_Optional(FileTitle: "FileTitle", FileType: "FileType", FileTime: "FileTime", FileDescription: "FileDescription", File: "File"))
                          );
                        },
                              ...
                              PopupMenuItem(
                                child: ListTile(
                                  onTap: (){
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(builder: (context) => EditNewFile_Page_Optional(FileTitle: "FileTitle", FileType: "Question", FileTime: "FileTime", FileDescription: "FileDescription", File: "File"))
                                    );
                                  },
